...
export function generateClinicalPDF({
    ...
    const drawFooter = () => {
        ...
        doc.setFontSize(6);
        doc.text(`Generated by Project Hyperion • ${new Date().toISOString()} • Page ${doc.internal.getNumberOfPages()}`, margin, footerY + 10);
    };

    const checkPageBreak = (neededHeight) => {
        const bottomLimit = 275; // Leave room for footer
    ...
    checkPageBreak(boxHeight + 20); // Header (10) + Space (10)
    ...
    checkPageBreak(reportBoxHeight + 20);
