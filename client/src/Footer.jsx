...
const footerLinks = [
  ...
  { label: 'API Reference', view: 'api-reference' },
...
export const Footer = ({ onNavigate }) => {
  return (
    <footer className="relative z-10 border-t border-blue-500/20 bg-slate-950/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((link) => (
                <a
                  key={link.name}
                  href={link.href}
                  className="p-2 rounded-lg text-slate-500 hover:text-cyan-400 hover:bg-slate-800 transition-all duration-200"
          ...
          {/* Links */}
          {['Product', 'Resources', 'Company'].map((section, si) => {
            const links = si === 0
            ...
            return (
              <div key={section}>
                <h4 className="text-xs font-bold tracking-widest uppercase text-slate-500 mb-4">{section}</h4>
